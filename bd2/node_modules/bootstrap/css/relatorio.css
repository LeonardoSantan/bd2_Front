...
body main .produtos .compra {
  ...
  max-width: calc(100% - 20px); /* Calcula o máximo de largura com margem */
  display: flex; /* Flex container para alinhar conteúdo */
  flex-direction: row; /* Direção de linha para layout compacto */
  align-items: center; /* Alinha itens ao centro verticalmente */
}
body main .produtos .compra img {
  width: 40%; /* Tamanho da imagem */
  height: auto;
  border-radius: 8px;
  margin-left: auto; /* Empurra a imagem para a direita */
}
body main .produtos .compra .compra-title {
  text-align: center;
}
body main .produtos .compra:hover {
  box-shadow: 0 8px 16px rgba(0, 0, 0, 0.2);
}
body main .produtos .compra-content {
  flex: 1; /* Ocupa todo o espaço disponível */
  padding-right: 10px; /* Espaçamento à direita para separar da imagem */
}
...
.truck-wrapper {
  ...
  height: 220px; /* Aumentar a altura para acomodar texto e caminhão */
  width: 220px; /* Aumentar a largura para manter proporção */
  border: 4px solid #ffc107;
  margin: 0 auto; /* Centraliza o contêiner no corpo */
  transform: scale(0.8);
  background: white;
...
.truck-wrapper:after {
  ...
  background: #ffc107;
  background: -moz-linear-gradient(left, #ffc107 0%, #be9311 100%);
  background: -webkit-linear-gradient(left, #be9311 100%, #ffc107 0%);
  background: linear-gradient(to right, #ffc107 0%, #be9311 100%);
  filter: progid:DXImageTransform.Microsoft.gradient( startColorstr="#ffc107", endColorstr="#be9311",GradientType=1 );
  color: white;
  padding-top: 8px;
  padding-bottom: 18px;
...
/*# sourceMappingURL=relatorio.css.map */
